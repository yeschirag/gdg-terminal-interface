...
export class CanvAscii {
  ...
  setMesh() {
    ...
    const textureCanvas = this.textCanvas.draw(text, {
    ...
    const scaleFactor = 0.5; // half of container height
    const planeH = this.height * scaleFactor / this.settings.asciiFontSize;
